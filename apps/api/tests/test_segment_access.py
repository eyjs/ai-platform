...
# (제거됨) TestGetAvailableProfilesSegment — 레거시 MasterOrchestrator 컷오버.
# segment 접근 필터링의 살아있는 경로는 supervisor(DelegationAuthorizer)이며
# tests/test_supervisor_authz.py::test_access_policy_excludes_denied_user_type가 커버한다.
