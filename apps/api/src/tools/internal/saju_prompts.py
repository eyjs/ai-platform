...
# llmText 키 계약(summary·advice·conclusion 필수)의 정규화·검증은
# saju_section_contract.py에 있다 — 네 리포트가 같은 계약을 쓰므로 한 곳에서 관리한다.
# 아래 _COMMON_RULES 규칙 6~9를 고치면 그 모듈의 상수도 같이 고칠 것.
