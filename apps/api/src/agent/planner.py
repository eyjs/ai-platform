...
- 비교/대조 질문은 **대상별로 rag_search를 분리**해 병렬로 계획하세요. 각 검색의
  query에 해당 대상명을 반드시 포함하세요. 예: "A상품이랑 B상품 가입 조건 비교" →
  {"steps": [
    {"step_id": "search_a", "tool": "rag_search", "params": {"query": "A상품 가입 조건"}, "group": 1},
    {"step_id": "search_b", "tool": "rag_search", "params": {"query": "B상품 가입 조건"}, "group": 1}
  ]}
- max_vector_chunks를 줄이지 마세요 (검색량은 시스템이 관리합니다)
